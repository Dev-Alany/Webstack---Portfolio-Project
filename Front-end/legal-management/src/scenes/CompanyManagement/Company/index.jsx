...
import { getAllCompanyRegionView, createUser, deleteUser } from "../../api/userservice";  // Import service functions
...
function Users() {
  ...
  useEffect(() => {
    fetchCompanyRegionView();
  }, []);

  const fetchCompanyRegionView = async () => {
    try {
      setLoading(true);
      const data = await getAllCompanyRegionView();
